"""The two stability boundaries: do lots come back, does the capital?
...
Backs eq:count-criterion and eq:capital-criterion in section 10.  Closed form
throughout -- both criteria are algebra on the drift, so there is nothing
expensive to declare.
...
TITLE = "Stability: the two boundaries"
SECTION = "sec:stability"
EQ = ["eq:count-criterion", "eq:capital-criterion"]
