...
Between the two boundaries lies a regime worth naming, because it is counterintuitive: **every lot comes back, and the capital still runs away.** Inventory is finite, each individual position resolves eventually, nothing looks broken from the inside — and expected capital is unbounded, because the rare very deep lots cost exponentially more than the common shallow ones. An operator in this band who reasons "every position I have ever held has eventually recycled" is stating something true and irrelevant.
